...
urlpatterns = [
    ...
    path('subsription_create/', views.SubscriptionCreateAPIView.as_view(), name='subsription-create'),
    path('subscription_delete/<int:pk>/', views.SubscriptionDeleteAPIView.as_view(), name='subscription-delete'),
